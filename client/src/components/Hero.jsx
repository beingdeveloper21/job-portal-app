  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
      <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white text-center py-16 mx-2 rounded-xl '>
        <h2 className='font-medium text-2xl md:text-3xl lg:text-4xl mb-4'>Over 10,000+ jobs to apply</h2>
     ...
     <div className='flex justify-center gap-8  lg:gap-14 flex-wrap'>
